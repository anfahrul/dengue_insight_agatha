...
<head>
    ...
    <link href="<?= base_url(); ?>/vendor/fontawesome-free/css/all_fontawasome.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - My profile -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('/profile/user'); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('/dashboard/view/file/bulan'); ?>">Arsipan tiap bulan</a>
                    </div>
                </div>
            </li>
